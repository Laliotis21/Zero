...
const el = {
  ...
  'results.pro.title': 'Pro ξεκλειδωμένο',
  'results.pro.body': 'Έχεις πρόσβαση στο AI Reverse Pricing και σε όλες τις λειτουργίες Pro.',
...
const en: Translations = {
  ...
  'results.paywall.price': '€2.99 · one-time',
  'results.paywall.cta': 'Upgrade',
  'results.pro.title': 'Pro unlocked',
  'results.pro.body': 'You have access to AI Reverse Pricing and all Pro features.',
