...
const el = {
  ...
  'results.paywall.title': 'Reverse Pricing',
  'results.paywall.body':
    'Βρες πόσο μικτό πρέπει να χρεώνεις για τον καθαρό μισθό που θες.',
  'results.paywall.price': '€2.99 / μήνα',
  'results.paywall.disclosure': 'Αυτόματη ανανέωση κάθε μήνα. Ακύρωση οποτεδήποτε.',
  'results.paywall.cta': 'Upgrade',
  'results.pro.title': 'Reverse Pricing',
  'results.pro.body': 'Δώσε τον καθαρό μισθό που θες — δες πόσο μικτό χρειάζεσαι.',
  'results.reverse.label': 'Στόχος καθαρών / μήνα',
  'results.reverse.placeholder': 'π.χ. 2000',
  'results.reverse.result': 'Χρέωσε {amount} / μήνα',
  'results.reverse.invalid': 'Δώσε έγκυρο ποσό για να υπολογίσεις.',
  ...
  'budget.export.net': 'Καθαρό μηνιαίο',
  'budget.export.footer': 'Δημιουργήθηκε από Zero · {date}',
  'budget.export.error.title': 'Η εξαγωγή απέτυχε',
  'budget.export.error.body': 'Δεν ήταν δυνατή η δημιουργία του PDF. Δοκίμασε ξανά.',
  ...
  'profile.proRestore': 'Επαναφορά αγορών',
  'profile.proActive': 'Το Pro είναι ενεργό',
  'profile.proActiveBody': 'Έχεις πρόσβαση σε όλες τις λειτουργίες Pro. Ευχαριστούμε!',
  ...
  'pro.success.title': 'Καλώς ήρθες στο Pro',
  'pro.success.body': 'Η αγορά ολοκληρώθηκε. Ξεκλείδωσες όλες τις λειτουργίες Pro.',
  'pro.unavailable.title': 'Μη διαθέσιμο',
  'pro.unavailable.body': 'Οι αγορές δεν είναι διαθέσιμες αυτή τη στιγμή. Δοκίμασε ξανά αργότερα.',
  'pro.error.title': 'Κάτι πήγε στραβά',
  'pro.error.body': 'Η αγορά δεν ολοκληρώθηκε. Δεν χρεώθηκες. Δοκίμασε ξανά.',
  'pro.restore.okTitle': 'Έγινε επαναφορά',
  'pro.restore.okBody': 'Οι αγορές σου επαναφέρθηκαν. Το Pro είναι ενεργό.',
  'pro.restore.noneTitle': 'Καμία αγορά',
  'pro.restore.noneBody': 'Δεν βρέθηκαν προηγούμενες αγορές για επαναφορά.',
...
const en: Translations = {
  ...
  'results.paywall.title': 'Reverse Pricing',
  'results.paywall.body':
    'Find the gross you need to charge for the net you want to take home.',
  'results.paywall.price': '€2.99 / month',
  'results.paywall.disclosure': 'Auto-renews monthly. Cancel anytime.',
  'results.paywall.cta': 'Upgrade',
  'results.pro.title': 'Reverse Pricing',
  'results.pro.body': 'Enter the net you want — see the gross you need.',
  'results.reverse.label': 'Target net / month',
  'results.reverse.placeholder': 'e.g. 2000',
  'results.reverse.result': 'Charge {amount} / month',
  'results.reverse.invalid': 'Enter a valid amount to calculate.',
  ...
  'budget.export.net': 'Monthly net',
  'budget.export.footer': 'Generated by Zero · {date}',
  'budget.export.error.title': 'Export failed',
  'budget.export.error.body': 'Could not generate the PDF. Please try again.',
  'budget.needs': 'NEEDS',
  'budget.wants': 'WANTS',
  ...
  'profile.proRestore': 'Restore purchases',
  'profile.proActive': 'Pro is active',
  'profile.proActiveBody': 'You have access to every Pro feature. Thank you!',
  ...
  'pro.success.body': 'Your purchase is complete. All Pro features are unlocked.',
  'pro.unavailable.title': 'Not available',
  'pro.unavailable.body': 'Purchases aren’t available right now. Please try again later.',
  'pro.error.title': 'Something went wrong',
  'pro.error.body': 'The purchase didn’t go through. You weren’t charged. Please try again.',
  'pro.restore.okTitle': 'Purchases restored',
  'pro.restore.okBody': 'Your purchases were restored. Pro is active.',
  'pro.restore.noneTitle': 'Nothing to restore',
  'pro.restore.noneBody': 'No previous purchases were found to restore.',
